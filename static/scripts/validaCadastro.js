...
async function fetchDatas(event) { // Tornar a função async para usar await
  ...
  const formData = {
    ...
    // `.trim`: Também é aplicado aqui limpar espaços em branco
    ...
    // garantindo que apenas os números do CPF sejam enviado.
    ...
    // não númericos, assegurando que apenas os dígitos do RG sejam transmitidos.
